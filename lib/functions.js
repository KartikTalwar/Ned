...
var it_has = function(it, has, number)
             {
                 var ret = (typeof number == "boolean" && number) ? true : false;
                 var out = (it.indexOf(has) != -1) ? true : false;

                 return (ret) ? it.indexOf(has) : out;
             }
...
exports.NedCaller          = /^([\@\!\#\$\~\%\/\\/]*)?/;
exports.NedName            = /([Nn][Ee][Dd][Dd]?([Dd]?[Yy])?( *[^A-Za-z0-9]* *)?)/;
exports.NedPMName          = /([Nn][Ee][Dd][Dd]?([Dd]?[Yy])?( *[^A-Za-z0-9]* *)? ?)?/;
exports.greet              = greet;
exports.cut                = cut;
